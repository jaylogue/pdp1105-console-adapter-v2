...
SystemState GlobalState::SystemState = SystemState::TerminalMode;
uint GlobalState::BaudRate = DEFAULT_BAUD_RATE;
uint GlobalState::DataBits = 8;
...
int main()
{
    ...
    while (true) {
        ...
        case SystemState::TerminalMode:
            TerminalMode_ProcessIO();
            break;
        case SystemState::MenuMode:
            MenuMode_ProcessIO();
            break;
        case SystemState::LoadFileMode_Monitor:
